...
const MOCK_SELLERS = [
  {
    ...
    avatarUrl: sellerAvatarImg,
    city: 'Cologne',
    country: 'Germany',
    description: 'Quality auto parts from Cologne. OEM and aftermarket brake pads, lighting, suspension. Fast shipping across Germany.',
    phone: '+49 221 555 12 34',
    whatsapp: '+492215551234',
    whatsappUrl: '+492215551234',
    instagramUrl: 'https://instagram.com/xirdalan_parts',
  ...
  },
  {
    ...
    city: 'Cologne',
    country: 'Germany',
    description: 'Auto parts specialist. Engine components, body parts, filters. OEM codes supported.',
    phone: '+49 221 555 98 76',
    whatsapp: '+492215559876',
    whatsappUrl: '+492215559876',
    instagramUrl: 'https://instagram.com/babek_parts',
